                ...
                <div class="row ">
                    <div class="col-lg-6">
                        <div class="why_choose">
                            <small class="text_primary title fontWeight500">
                                About Us
                            </small>
                            ...
                            <p class="mt-4 text_secondary">
                                Affinity Builders is dedicated to providing extra care to each project from
                            ...
                            <div class="mt-4">
                                <a class="btn_3" href="tel:267-645-9005">
                ...
                <div class="row  align-items-lg-center">
                    ...
                    <div class="col-lg-6 ps-5">
                        ...
                        <p class="mt-4 text-white">
                            ...
                            place
                            where memories are made and traditions are honored; that’s why attention to detail is the
                            cornerstone of renovations at Affinity Builders. Residential renovations require careful
                            ...
                            functionality
                            and breathe new life into a space.


                        </p>
                        <p class="mt-3 text-white">
                            Our entire process is tailor-made for the client while serving the overall vision and
                            direction
                            of the design-plan.
                        </p>
